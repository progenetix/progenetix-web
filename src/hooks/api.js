...
export function useBioSubsets({ filters, datasetId }) {
  const url = `${basePath}api/?apidb=${datasetId}&apiscope=biosubsets&apimethod=subsetdata&filters=${filters}&apioutput=json`
  return useExtendedSWR(url)
}
