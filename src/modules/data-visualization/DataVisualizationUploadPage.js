  ...
  return (
    ...
    >
      ...
      <Panel
        ...
        className="content"
      >
        <p>Data has to be submitted as tab-delimited <b>.tsv</b> segment files.
        An example file is being provided <a href="/examples/multi-sample-segments-unfiltered.tsv" target="_blank">here</a>.</p>
        
        <p>While the header values are not being interpreted, the column order
        has to be followed:</p>

        <ol>
          <li><code>sample</code>
            <ul>
              <li>please use only word characters, underscores, dashes</li>
              <li>the <code>sample</code> value is used for splitting multi-sample files into their individual profiles</li>
            </ul>
          </li>
          <li><code>chro</code>
            <ul>
          ...
          <li><code>mean</code>
            <ul>
              ...
              <li>0-centered</li>
              <li>segments not passing the calling thresholds (fallback <code>0.15</code>, <code>-0.15</code>) are being filtered out</li>
              <li>one can use dummy values (e.g. <code>1</code> for gains, <code>-1</code> for losses)</li>
            </ul>
          </li>
          <li><code>probes</code>
            <ul>
