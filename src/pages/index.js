  ...
  return (
    <Layout title="Progenetix" headline="Cancer genome data @ progenetix.org">
      ...
      <Panel heading="The Progenetix Resource" className="content">
        ...
        <div className="content">
          ...
          <div className="has-text-centered">
            <small>
              Example for aggregated CNV data in {randomSubset.count} samples in {randomSubset.label}.<br/>Here the frequency of regional <span className="span-gain-color">copy number gains</span> and <span className="span-loss-color">losses</span> are displayed for all 22 autosomes.
            </small>         
          </div>
        </div>
      ...
      <Panel heading="Progenetix Use Cases"  className="content">
        ...
        <p>
          The progenetix resource contains data of{" "}<span className="span-red">{ncitCountResponse}</span>{" "}different cancer types (NCIt neoplasm classification), mapped to a variety of biological and technical categories. Frequency profiles of regional genomic gains and losses for all categories (diagnostic entity, publication, cohort ...) can be accessed through the <a href="/subsets/biosubsets">[ Cancer Types ]</a> page with direct visualization and options for sample retrieval and plotting options.
          </p>
        ...
        <p>
          Through the <a href="/subsets/biosubsets">[ Publications ]</a> page Progenetix provides{" "}<span className="span-red">{progenetixStats.results[0].counts.publications}</span>{" "}annotated references to research articles from cancer genome screening experiments (WGS, WES, aCGH, cCGH). The numbers of analyzed samples and possible availability in the Progenetix sample collection are indicated.
          </p>
